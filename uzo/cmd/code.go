...
import (
	...
	"github.com/jan-may/go-learning/uzo/util"
...
var codeCmd = &cobra.Command{
	...
	Long: 
	`This command will help to open the unzipped folder to Visual Studio Code.
...
func init() {
	...
	codeCmd.PersistentFlags().StringVarP(&File, "file", "f","", "A file name to open in IDE")
